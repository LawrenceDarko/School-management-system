...
class StudentNews(models.Model):
    ...
    news_image = models.ImageField(upload_to='NewsImages/', blank=True, null=True)
...
class SchoolGallery(models.Model):
    ...
    image = models.ImageField(upload_to='SchoolGallery/', blank=True, null=True)
...
class StaffInfo(models.Model):
    ...
    staff_image = models.ImageField(upload_to='StaffImages/', blank=True, null=True)
