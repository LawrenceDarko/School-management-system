...
class Students(models.Model):
    ...
    #class_year=models.DecimalField(max_digits=3)
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now_add=True)
    fcm_token=models.TextField(default="")
    objects = models.Manager()
...
class StudentResult(models.Model):
    ...
    #subject_exam_marks=models.FloatField(default=0, blank=True, null=True)
    #subject_assignment_marks=models.FloatField(default=0, blank=True, null=True)
    subject_result_file=models.ImageField(upload_to='', blank=True, null=True)
